...
mv /tmp/bundling340.files /opt/processmaker/shared/sites/$WORKSPACE
...
mysql -u RDSPortainer -pD9PZ82hadX78dp*3 -h portainer.ckz0mnb6cuna.us-east-1.rds.amazonaws.com wf_$WORKSPACE < /tmp/wf_bundling340.sql
