...
# Extra
LABEL version="3.3.0"
LABEL description="ProcessMaker 3.3.0 Enterprise Trial Container."
...
RUN wget -O "/tmp/processmaker-3.3.0.tar.gz" \
      "https://artifacts.processmaker.net/generic/processmaker-3.3.0-trial.tar.gz"
RUN wget -O "/tmp/bundle.tar.gz" \
      "https://artifacts.processmaker.net/generic/bundle-3.3.0.tar.gz"
