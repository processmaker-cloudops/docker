...
LABEL description="ProcessMaker 3.3.15 Docker Container."
...
RUN wget -O "/tmp/processmaker-3.3.15.tar.gz" \
      "https://artifacts.processmaker.net/official/processmaker-3.3.15.tar.gz"
